...
Main question here is whether leading and trailing SGR are selected in the
replacement:

    substr_ctl("A\033[31mhello\033[42mB", 2, 6) <- "\033[32mgoodbye\033[0m"

First reaction is that all the leading SGR should be consumed.  The tricky
business starts when we have other zero width stuff, like an accent, or an emoji
ZWJ sequence with a color change in the middle.
