...
* finds the start of the escape
* attempts to read it
* warns if it is a malformed illegal one
* returns the number of bytes in the escape

Then,

* has_ctl reports whether there was one.
* strip_ctl strips it.
* nzchar_ctl keeps looking for characters.
